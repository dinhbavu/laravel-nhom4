...
class DatTour extends Model
{
    ...
    protected $fillable = [
        ...
        'tong_tien_goc', 'giam_gia', 'tong_tien_thanh_toan', 'tong_tien_da_thanh_toan',
        'ghi_chu', 'trang_thai', 'ly_do_huy', 'nguoi_duyet_id',
    ];

    public function isFullyPaid()
    {
        return $this->tong_tien_da_thanh_toan >= $this->tong_tien_thanh_toan;
    }
