...
New-Item -ItemType Directory -Force -Path C:\xampp\htdocs\VietGo\patch\images | Out-Null
New-Item -ItemType Directory -Force -Path C:\xampp\htdocs\VietGo\patch\resources\views\layouts | Out-Null
Copy-Item C:\xampp\htdocs\VietGo\public\build -Destination C:\xampp\htdocs\VietGo\patch\build -Recurse -Force
Copy-Item C:\xampp\htdocs\VietGo\public\images\*_3d.jpg -Destination C:\xampp\htdocs\VietGo\patch\images\ -Force
