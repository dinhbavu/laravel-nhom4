...
@section('title', 'Đăng Nhập - VietGo 3D')
...
<div class="auth-full">
    <div class="auth-box">
        <div class="auth-logo-wrap">
            ...
            <div class="auth-logo-text">Cổng Đăng Nhập <span>VietGo</span></div>
            <p class="auth-welcome">Bắt đầu hành trình khám phá cùng VietGo!</p>
        </div>
        ...
        <form action="{{ route('dang-nhap.xu-ly') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <div style="position:relative;">
                    <i class="fa-solid fa-envelope" style="position:absolute;left:.9rem;top:50%;transform:translateY(-50%);color:#4ade80;"></i>
                    <input type="email" id="email" name="email" class="form-control" placeholder="nhap@email.com" value="{{ old('email', $emailDaLuu ?? '') }}" required autofocus>
                </div>
            </div>

            <div class="form-group">
                <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:.5rem;">
                    <label class="form-label" for="mat_khau" style="margin:0;">Mật khẩu</label>
                    <a href="{{ route('quen-mat-khau.email') }}" style="font-size:.8rem;color:#4ade80;text-decoration:none;">Quên mật khẩu?</a>
                </div>
                <div style="position:relative;">
            ...
            <div style="display:flex; align-items:center; gap:.5rem; margin-bottom:2rem;">
                <input type="checkbox" id="ghi_nho" name="ghi_nho" value="1" style="accent-color:#4ade80;width:1rem;height:1rem;" {{ !empty($emailDaLuu) ? 'checked' : '' }}>
                <label for="ghi_nho" style="font-size:.875rem;color:rgba(255,255,255,0.5);cursor:pointer;">Ghi nhớ đăng nhập</label>
            </div>
        ...
        <div style="text-align:center; margin-top:2rem; padding-top:1.5rem; border-top:1px solid rgba(255,255,255,0.06);">
            <p style="font-size:.875rem;color:rgba(255,255,255,0.5);">
                Chưa có tài khoản?
                <a href="{{ route('dang-ky') }}" style="color:#4ade80;font-weight:700;text-decoration:none;">Đăng ký ngay</a>
            </p>
        </div>
    </div>
</div>
