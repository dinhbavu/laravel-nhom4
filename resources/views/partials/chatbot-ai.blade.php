...
(function () {
    ...
    async function sendMessage(text) {
        ...
        try {
            // Gọi qua backend Laravel (đã chạy local nên không bị chặn outbound HTTP)
            ...
            if (!response.ok) {
                ...
                console.error('Chatbot API Error:', errData);
            ...
            hideTyping();
            appendMessage('bot', '⚠️ Không thể kết nối AI lúc này. Vui lòng thử lại sau!');
        }
