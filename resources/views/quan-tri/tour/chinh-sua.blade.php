                ...
                <div class="card-body">
                    ...
                    <div class="grid-2">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nhap_diem_den" class="form-control" value="{{ old('nhap_diem_den', $tour->diemDen->ten_diem_den ?? '') }}" placeholder="VD: Vịnh Hạ Long, Sapa..." list="ds_diem_den" required>
                            <datalist id="ds_diem_den">
                                @foreach($danh_sach_diem_den as $dd)
                                <option value="{{ $dd->ten_diem_den }}">{{ $dd->vung_mien_ten }}</option>
                                @endforeach
                            </datalist>
