...
<div class="table-card">
    ...
    <form action="{{ route('quan-tri.tour.danh-sach') }}" method="GET">
        <div class="filter-bar">
            ...
            <select name="vung_mien" class="form-control">
            ...
            <select name="diem_den" class="form-control">
                <option value="">Tất cả điểm đến</option>
                @foreach($danh_sach_diem_den as $dd)
        ...
        <table class="data-table" style="min-width: 1100px;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <span class="badge badge-info" style="font-size:12px; background: rgba(59,130,246,0.1); color:#3b82f6; border:1px solid rgba(59,130,246,0.2);">
                            {{ $tour->diemDen->vung_mien_ten ?? 'N/A' }}
                        </span>
                    </td>
                    <td>
